...
- **2026-09-10 房产估算 + AI 语气档两项改动本地提交（主分支 `main`，未推送）**：
  - `fc79cbc` fix: 房产估算提示改进 — 详情页占位文案明确化、表单城市收紧 70 城、指数最新月独立展示
  - `a208cb6` feat: AI 报告语气档（分析师/伙伴）与设置页隐私宣言
  - 552 个单元测试全绿；APK：`apk/RICHWIN-AI语气与隐私宣言-20260910.apk`（用户已认可提交）
